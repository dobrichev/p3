...
gcc_profiling:
	...
	$(GCXX) -flto -O3 -march=native -g -Wall -fprofile-generate -fopenmp -o $(TARGET) $(FILELIST)
	@echo 'Done'

gcc_release:
	@echo 'Building target $(TARGET) using Gnu C++ Profile Use settings'
	$(GCXX) -flto -O3 -march=native -msse4.2 -mavx -fno-strict-aliasing -g -Wall -fprofile-use -fopenmp -o $(TARGET) $(FILELIST)
	@echo 'Done'
